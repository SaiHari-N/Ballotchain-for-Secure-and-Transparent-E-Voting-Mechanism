...
$id=$mr['max(id)']+1;
$qry=mysqli_query($connect,"insert into vt_division(id,district,division,user) values($id,'$district','$division2','$user')");
	if($qry)
	{
	?>
...
$qry=mysqli_query($connect,"insert into vt_candidate(id,division,name,caption,symbol,gender,age,contact,rdate,user) values($id,'$division','$name','$caption','$symbol','$gender','$age','$contact','$rdate','$user')");
if($qry)
{
									...
									?>
										...
										<div class="form-group">
                                            ...
                                            <div class="col-sm-10">
											  ...
											  <?php
											  $dq2=mysqli_query($connect,"select * from vt_division where user='$user' && district='$district'");
