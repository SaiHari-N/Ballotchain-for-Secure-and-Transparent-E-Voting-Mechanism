...
mysqli_query($connect,"update vt_status set vdate='$edate1',stime='$stime',etime='$etime',election_st=0 where uname='$user'");

mysqli_query($connect,"update vt_voter set vote_st='0' && user='$user'");
mysqli_query($connect,"update vt_candidate set vcount='0' && user='$user'");
mysqli_query($connect,"delete from vt_blockchain where status='vote' && user='$user'");
mysqli_query($connect,"delete from vt_vote_reg where user='$user'");
	?>
