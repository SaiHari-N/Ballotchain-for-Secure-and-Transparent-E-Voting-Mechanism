...
$mq2=mysqli_query($connect,"select count(*) from vt_officer1 where user='$user'");
...
$qry=mysqli_query($connect,"insert into vt_officer1(id,state,name,contact,email,uname,pass,user) values($id,'$state','$name','$contact','$email','$uname','$pass','$user')");
		   ...
		   <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
						<?php
						$qry=mysqli_query($connect,"select * from vt_officer1 where user='$user'");
