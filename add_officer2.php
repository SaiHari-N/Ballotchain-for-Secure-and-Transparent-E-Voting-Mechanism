...
$mq2=mysqli_query($connect,"select count(*) from vt_booth where user='$user'");
...
$qry=mysqli_query($connect,"insert into vt_booth(id,booth,name,area,city,division,contact,email,uname,pass,user) values($id,'$booth','$name','$area','$district','$division','$contact','$email','$uname','$pass','$user')");
		   ...
		   <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
						<?php
						$qry=mysqli_query($connect,"select * from vt_booth where division='$div2' && user='$user'");
