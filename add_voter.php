...
$qry=mysqli_query($connect,"insert into vt_voter(id,division,voterid,name,gender,dob,address,area,city,contact,email,aadhar,pass,rdate,user) values($id,'$division','$voterid','$name','$gender','$dob1','$address','$area','$city','$contact','$email','$aadhar','$pass','$rdate','$user')");
...
if($qry)
{
	...
	mysqli_query($connect,"insert into vt_blockchain(id,block_id,pre_hash,hash_value,sdata,status,user) values($id2,'$id','$pre_hash','$hash','$data','reg','$user')");
	//////////////////////////////////////////////////////////////
	
	//get fingerprint
	mysqli_query($connect,"update vt_status set status=2,fid=$id where uname='$user'");
									 ...
									 <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
											  ...
											  <option value="">-District-</option>
											   <?php
											  $dq=mysqli_query($connect,"select distinct(district) from vt_division where user='$user' order by district");
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select name="division" class="form-control">
												   <?php
											  $dq2=mysqli_query($connect,"select * from vt_division where district='$city' && user='$user'");
