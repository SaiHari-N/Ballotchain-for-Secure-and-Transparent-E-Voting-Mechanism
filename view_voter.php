...
<body>
	...
	<option value="">-District-</option>
      <?php
	$cq1=mysqli_query($connect,"select distinct(city) from vt_voter where user='$user'");
	...
	?>
      ...
      <?php
	$cq2=mysqli_query($connect,"select distinct(division) from vt_voter where city='$city' && user='$user'");
	...
	?>
			...
			<?php
  $qry=mysqli_query($connect,"select * from vt_voter where city='$city' && division='$division' && user='$user'");
